...
## Características
  ...
  - Gestión de estados de habitaciones: disponible, ocupada, en limpieza, en mantenimiento.
  - Asignación inteligente de tareas de limpieza basada en prioridad y reservas.
...
- **Objetivos**:
  ...
  - Crear una NavBar
  - Crear los primeros componentes
- **Avances**:
